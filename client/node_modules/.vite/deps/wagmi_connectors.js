import {
  ...
  injected,
  mock
} from "./chunk-QBEF5S3D.js";
import {
  withRetry,
  withTimeout
} from "./chunk-WFWOEFFY.js";
import "./chunk-GEG7GMLK.js";
import "./chunk-2Q65U5PX.js";
import "./chunk-LIF5ZLBT.js";
import {
  ...
  getAddress,
  numberToHex
} from "./chunk-2AZDA7ZC.js";
import "./chunk-S2AXSKFF.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./connectors_false-LXPEHUOR.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./connectors_false-UA6NZIIS.js");
          } catch {
      ...
      if (!metamask) {
        if (!metamaskPromise) {
          const { createEVMClient } = await (async () => {
            try {
              return import("./connectors_false-TTA5OAOV.js");
            } catch {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("./connectors_false-IKSTUFSV.js");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("./connectors_false-XXUKXI5U.js");
              } catch {
    ...
    async getProvider() {
      ...
      if (!provider_) {
        const { default: SDK } = await (() => {
          try {
            return import("./connectors_false-SIFZAXFR.js");
          } catch {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./connectors_false-IEMONIA2.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./connectors_false-H5YXOKKK.js");
          } catch {
